...
<body>
    <div class="w3-bar w3-black w3-center navbarWidth">
        <a href="index.php" id="hyvebook">HyveBook</a>
        <a href=" index.php" id='homeButton' class=" w3-button w3-mobile navbarButtonWidth">Home</a>
        <a href="friend.php" id='friendsButton' class=" w3-button w3-mobile navbarButtonWidth">Friends</a>
        <a href="profile.php" id='profileButton' class=" w3-button w3-mobile navbarButtonWidth">Profile</a>
